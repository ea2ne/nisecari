$(function(){
  ...
  function appendChildrenBox(insertHTML){
    ...
    $('.sell__main__content__form__box__group__form').append(childSelectHtml);
  }
  function appendGrandchildrenBox(insertHTML){
    ...
    $('.sell__main__content__form__box__group__form').append(grandchildSelectHtml);
  }
  ...
  $('.sell__main__content__form__box__group__form').on('change','#child__category',function(){
